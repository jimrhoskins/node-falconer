...
(function() {
  ...
  Falconer = (function(_super) {
    ...
    function Falconer(options) {
      ...
      this.poll = (_ref1 = options.poll) != null ? _ref1 : false;
      this.pollPath = (_ref2 = options.pollPath) != null ? _ref2 : '/@falconer-poll';
      this.pollInterval = (_ref3 = options.pollInterval) != null ? _ref3 : 1000;
      this.pollEvents();
    }
