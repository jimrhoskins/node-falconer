(function() {
  ...
  Request = (function(_super) {
    ...
    Request.prototype.json = function(payload) {
      ...
      return this.header('Content-Length', this.data[0].length);
    };
    ...
    Request.prototype.socket = function(socket) {
      var _ref, _ref2;
      if ((_ref = socket.handshake) != null ? (_ref2 = _ref.headers) != null ? _ref2.cookie : void 0 : void 0) {
        this.header('cookie', socket.handshake.headers.cookie);
      }
      return this;
    };
